...
@section('subhead')
    <title>SAITAMA - Create Laptop Info</title>
@endsection
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <x-base.form-input class="w-full" id="crud-form-1" type="text" placeholder="Input text" />
                </div>
                <div class="mt-3">
                    <x-base.form-label for="crud-form-2">Category</x-base.form-label>
                    <x-base.tom-select class="w-full" id="crud-form-2" multiple>
                ...
                <div class="mt-3">
                    ...
                    <x-base.input-group inputGroup>
                        <x-base.form-input id="crud-form-3" type="text" aria-describedby="input-group-1"
                ...
                <div class="mt-3">
                    ...
                    <x-base.input-group inputGroup>
                        <x-base.form-input id="crud-form-4" type="text" aria-describedby="input-group-2"
                            placeholder="Weight" />
                ...
                <div class="mt-3">
                    ...
                    <div class="grid-cols-3 gap-2 sm:grid">
                        <x-base.input-group inputGroup>
                            ...
                            <x-base.form-input type="text" aria-describedby="input-group-3" placeholder="Unit" />
                        </x-base.input-group>
                        <x-base.input-group class="mt-2 sm:mt-0" inputGroup>
                            <x-base.input-group.text id="input-group-4">
                                Wholesale
                            </x-base.input-group.text>
                            <x-base.form-input type="text" aria-describedby="input-group-4" placeholder="Wholesale" />
                        </x-base.input-group>
                        <x-base.input-group class="mt-2 sm:mt-0" inputGroup>
                            <x-base.input-group.text id="input-group-5">Bulk</x-base.input-group.text>
                            <x-base.form-input type="text" aria-describedby="input-group-5" placeholder="Bulk" />
                        </x-base.input-group>
                    </div>
                </div>
                <div class="mt-3">
                ...
                <div class="mt-5 text-right">
                    ...
                    <x-base.button class="w-24" type="button" variant="primary">
                        Save
                    </x-base.button>
                </div>
            </div>
